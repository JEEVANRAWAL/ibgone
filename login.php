...
if (isset($_POST['submit'])) {
    ...
    $conn = mysqli_connect("localhost", "root", "", "IBG");
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id='btn-logout-true'>Logout</button>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form id="login_form" action="login.php" method="post" class="user">
