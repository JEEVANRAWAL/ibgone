...
<div class="container-fluid">
    <div class="container shadow-lg p-3 mb-5 mt-5 bg-white rounded">
        ...
        <form action="upload-id-card-form.php" method="post" id="user-details-form" enctype="multipart/form-data">
            <!-- basic information -->
            <div class="form-group row mt-2 mb-1">
                <label for="user-name" class="col-sm-2 col-form-label">Full Name</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="name" id="user-name" placeholder="Full Name" required>
                </div>
            </div>
            ...
            <div class="form-group row mt-2 mb-1">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="title" id="user-title" placeholder="Title" required>
                </div>
            </div>
            ...
            <div class="form-group row mt-2 mb-1">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" name="id-no" id="user-title" placeholder="ID number" required>
                </div>
            </div>
            ...
            <div class="form-group row mt-2 mb-1">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="organization" id="user-organization" placeholder="Organization name" required>
                </div>
            ...
            <div class="form-group row mt-2 mb-1">
                ...
                <div class="col-sm-10">
                    <input type="datetime-local" class="form-control" name="issue" id="user-issue-date" placeholder="Issue Date" required>
                </div>
            </div>
            ...
            <div class="form-group row mt-2 mb-1">
                ...
                <div class="col-sm-10">
                    <input type="datetime-local" class="form-control" name="expire" id="user-expire-date" placeholder="Expire Date" required>
                </div>
            </div>
